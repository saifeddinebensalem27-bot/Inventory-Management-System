 ...
 */
final class Version20260128222746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sales_history (id_history_sel INT AUTO_INCREMENT NOT NULL, id_vente INT NOT NULL, INDEX IDX_29430C2B660F6B7C (id_vente), PRIMARY KEY (id_history_sel)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE sales_history ADD CONSTRAINT FK_29430C2B660F6B7C FOREIGN KEY (id_vente) REFERENCES vente (id_vente)');
        ...
        $this->addSql('ALTER TABLE incoming_history ADD CONSTRAINT FK_226B63A9D1A5800F FOREIGN KEY (id_entre) REFERENCES entree (id_entre)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sales_history DROP FOREIGN KEY FK_29430C2B660F6B7C');
        $this->addSql('DROP TABLE sales_history');
        ...
        $this->addSql('ALTER TABLE incoming_history DROP FOREIGN KEY FK_226B63A9D1A5800F');
