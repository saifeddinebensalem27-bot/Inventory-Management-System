 ...
 */
final class Version20260122222435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP categorie, DROP unite');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie VARCHAR(255) NOT NULL, ADD unite VARCHAR(255) NOT NULL');
